...
import com.sklambda.elements.expressions.ExprListenerOrigin;
...
import com.sklambda.elements.sections.SecStrayBlock;
...
public final class ListenerModule implements AddonModule {
	...
	public void load(@NotNull SkriptAddon addon) {
		...
		SecStrayBlock.register(registry);
		ExprWatchValue.register(registry);
		ExprListenerOrigin.register(registry);
